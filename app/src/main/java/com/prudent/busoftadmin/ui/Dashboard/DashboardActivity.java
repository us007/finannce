...
import com.prudent.busoftadmin.ui.formsummary.FormSummaryActivity;
import com.prudent.busoftadmin.ui.salesorder.SalesOrderActivity;
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (id) {
                    ...
                    case R.id.menu_cheque_receipt:
                        ...
                        break;
                    case R.id.menu_form_summary:
                        drawerLayout.closeDrawers();
                        Intent intent = new Intent(getApplicationContext(), FormSummaryActivity.class);
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    case R.id.menu_sales_order:
                        drawerLayout.closeDrawers();
                        Intent salesOrderIntent = new Intent(getApplicationContext(), SalesOrderActivity.class);
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            startActivity(salesOrderIntent, ActivityOptions.makeSceneTransitionAnimation(DashboardActivity.this).toBundle());
                        } else {
        ...
        dashboardSpinBranch.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapter, View v,
                ...
                try {
                    ...
                    BranchXcode = v.findViewById(R.id.tvCategory).getTag().toString();
