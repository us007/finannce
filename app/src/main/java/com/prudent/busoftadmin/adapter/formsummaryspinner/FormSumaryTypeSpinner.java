package com.prudent.busoftadmin.adapter.formsummaryspinner;
...
public class FormSumaryTypeSpinner extends ArrayAdapter<String> {
    private Context contextSpinner;
    private ArrayList<String> data;
    private LayoutInflater inflater;

    public FormSumaryTypeSpinner(Context context, ArrayList<String> resource) {
